...
{
    // Keeps close/minimize/tray-exit decisions deterministic and independently testable.
    public sealed class BackgroundLifecycle
    {
        ...
        public bool ShouldHideOnMinimize { get { return ContinueInBackground && !_explicitExit; } }
